<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddProgram.aspx.cs" Inherits="WebPortal.SystemPages.AddProgram" %>
        ...
        <ContentTemplate>
            <div class="pagetitle">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Add Program Information</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    ...
                    <h5 class="card-title">Add Program Information</h5>
                </div>
                <div class="card-body">
                    <!--Success alert-->
                    ...
                    <div class="col-md-4">
                        <div class="row g-3">
                            <div class="col-md-12 form-group">
                                <asp:Label ID="ProgramDetailsLabel" runat="server" AssociatedControlID="txtProgramDetails" CssClass="form-label">Description 
                            ...
                            <div class="col-md-12 form-group">
                                <asp:Label ID="ProgramLabel" runat="server" AssociatedControlID="ddlProgrammeType" CssClass="form-label">Program type <span class="red-star">*</span> :</asp:Label>
                            ...
                            <div class="col-md-12 form-group">
                                <asp:Label ID="lblDescriptionShort" runat="server" AssociatedControlID="txtDescriptionShort" CssClass="form-label">Description short <span class="red-star">*</span> :</asp:Label>
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDescriptionShort"
                                        CssClass="failureNotification" ErrorMessage="*Description short is required." Display="Dynamic"
                                        ToolTip="Description short is required." ValidationGroup="RegisterUserValidationGroup"></asp:RequiredFieldValidator>
