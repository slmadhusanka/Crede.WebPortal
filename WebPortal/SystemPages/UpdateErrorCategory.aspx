<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateErrorCategory.aspx.cs" Inherits="WebPortal.SystemPages.UpdateErrorCategory" %>
              ...
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Table Maintenance</li>
                    <li class="breadcrumb-item">Error Category</li>
                  <li class="breadcrumb-item active">Edit Error Category</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <asp:HyperLink CssClass="btn-circle btn btn-back" ID="HyperLink1" runat="server" NavigateUrl="~/SystemPages/ListOfErrorCategory.aspx"><i class="fa fa-arrow-left" aria-hidden="true"></i></asp:HyperLink>
                    <h5 class="card-title">Edit Error Category</h5>
                </div>
                <div class="card-body">
                    <!--Success alert-->
                ...
                <div class="card-footer">
                    <div class="pull-right">
                        <asp:LinkButton ID="btnRefresh" runat="server" CssClass="btn btn-secondary btn-sm" CausesValidation="false" PostBackUrl="~/SystemPages/ListOfErrorCategory.aspx">
