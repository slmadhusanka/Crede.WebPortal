<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListOfProgram.aspx.cs" Inherits="WebPortal.SystemPages.ListOfProgram" %>
          ...
          <div class="row">
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <div class="pull-left">
                        <h35 class="card-title">Programs</h35>
                    </div>
                    <div class="pull-right">
                        <asp:LinkButton ID="btnAddNew" runat="server" PostBackUrl="~/SystemPages/AddProgram.aspx"
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="table-responsive">
                                <asp:GridView ID="gvProgram" runat="server" AutoGenerateColumns="False" GridLines="Vertical"
                                    OnRowEditing="gvProgram_RowEditing" OnRowDataBound="gvProgram_RowDataBound"
                                    ShowHeaderWhenEmpty="true" CssClass="table table-bordered table-striped table-hover">
                                    <Columns>
                                        <asp:BoundField HeaderText="Program Code" DataField="Program_Code" ItemStyle-CssClass="hide1"
                                            HeaderStyle-CssClass="hide1">
                                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                            <HeaderStyle Wrap="False" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Program" DataField="Program_Desc">
                                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                            <HeaderStyle Wrap="False" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Program type code" DataField="Program_Type_Code">
                                            <ItemStyle HorizontalAlign="Left" CssClass="hide1" />
                                            <HeaderStyle Wrap="False" CssClass="hide1" />
                                        </asp:BoundField>
                                        <asp:BoundField HeaderText="Program type" DataField="Program_Type_Desc">
                                            <ItemStyle HorizontalAlign="Left" Wrap="False" />
                                            <HeaderStyle Wrap="False" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField HeaderText="DescriptionShort" DataField="DescriptionShort">
                                            <ItemStyle HorizontalAlign="Left" CssClass="hide1" Wrap="False" />
                                            <HeaderStyle Wrap="False" CssClass="hide1" />
                                        </asp:BoundField>
                                                 ...
                                                 <div class="btn-group">
                                                  <button class="btn btn-outline-primary btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <asp:LinkButton style="color: #212529;" ID="btnEdit" CssClass="dropdown-item" runat="server" CommandName="Edit"
                                                                AlternateText="Edit" ToolTip="Click to Edit">
                                                                <i class="bi bi-pencil"></i> Edit
                                                            </asp:LinkButton>
                                                        </li>
                                                        <li>
                                                            <button style="color: #dc3545;" type="button" class="dropdown-item" onclick='customDeleteDialouge("<%# Eval("Program_Code") %>", "<%# HttpUtility.JavaScriptStringEncode(Convert.ToString(Eval("Program_Desc"))) %>")'>
...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="PageScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function pageLoad() {
            $('#MainContent_gvProgram> thead > tr:eq(0)').find('.no-sort').attr('data-orderable', 'false');

            var table = $("#MainContent_gvProgram").DataTable({
                pageLength: 100,
                "order": [[0, "desc"]],
                dom: "lrt<'myinfo'i>p",
        ...
        function customDeleteDialouge(id, message) {
            var text = "Are you sure you want to delete '" + message + "' program?";
            var title = "Delete '" + message + "' program";
            $('#dvAlert').html(text);
                ...
                buttons: {
                    ...
                    delete: {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "ListOfProgram.aspx/DeleteProgram",
