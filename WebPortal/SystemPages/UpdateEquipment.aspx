<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateEquipment.aspx.cs" Inherits="WebPortal.SystemPages.UpdateUnitM" %>
        ...
        <ContentTemplate>
            <div class="pagetitle">    
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Edit Equipment Information</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <asp:HyperLink CssClass="btn-circle btn btn-back hide"  ID="HyperLink1" runat="server" NavigateUrl="~/SystemPages/ListOfEquipment.aspx"><i class="fa fa-arrow-left" aria-hidden="true"></i></asp:HyperLink>
                    <h5 class="card-title">Edit Equipment Information</h5>
                </div>
                <div class="card-body">
                    <!--Success alert-->
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group hide hide1">
                            <asp:Label ID="UnitCodeLabel" runat="server" CssClass="control-label col-xs-12 col-sm-4 col-lg-3" AssociatedControlID="lblUnitCode" Visible="false">Equipment code:</asp:Label>
                           
                                <asp:Label ID="lblUnitCode" runat="server" AssociatedControlID="txtUnitName" Visible="false"></asp:Label>
                        ...
                        <div class="form-group col-md-6 ">
                            <asp:Label ID="lblUnitType1" runat="server" AssociatedControlID="ddlUnitType1" CssClass="form-label">Equipment type <span class="red-star">*</span> :</asp:Label>
                                ...
                                <asp:DropDownList ID="ddlUnitType1" runat="server" CssClass="form-control">
                                </asp:DropDownList>
...
<%--                        <div class="form-group col-md-6 " CssClass="hide1">
                            <asp:Label ID="lblUnitType2" runat="server" AssociatedControlID="ddlUnitType2" CssClass="form-label">Unit type 2 <span class="red-star">*</span> :</asp:Label>
                                ...
                                <asp:DropDownList ID="ddlUnitType2" runat="server" CssClass="form-control">
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator ID="rfvUnitType2" runat="server" ControlToValidate="ddlUnitType2" Display="Dynamic"
                                    ...
                                    ValidationGroup="RegisterUserValidationGroup"> </asp:RequiredFieldValidator> CssClass="hide1"
...
<%--                        <div class="form-group col-md-6 ">
                        ...
                        <div class="form-group hide hide1">
                            <asp:Label ID="Label2" runat="server" AssociatedControlID="txtOrderID" CssClass="form-label">Order id <span class="red-star">*</span> :</asp:Label>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtOrderID"
                                    CssClass="failureNotification" ErrorMessage="*Order id is required." ToolTip="Order id is required."
                                    ValidationGroup="RegisterUserValidationGroup"></asp:RequiredFieldValidator>
                                <ajaxtool:FilteredTextBoxExtender runat="server" ID="filtertextboc1" TargetControlID="txtOrderID"
                         ...
                         <div class="form-group col-md-6 hide">
                            <asp:Label ID="Label1" runat="server" AssociatedControlID="txtbeds" CssClass="form-label">Approximate number of beds <span class="red-star">*</span> :</asp:Label>
                                ...
                                <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtbeds" --%>
                                <%--     CssClass="failureNotification" ErrorMessage="*Unit description short is required." Display="Dynamic" --%>
