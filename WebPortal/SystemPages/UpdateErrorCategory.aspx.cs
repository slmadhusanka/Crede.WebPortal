...
{
    public partial class UpdateErrorCategory : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (Session["RegionData"] != null)
                    {
                        ...
                        ErrorCategory objError = (ErrorCategory)(Session["RegionData"]);
                    ...
                    {
                        Response.Redirect("~/SystemPages/ListOfErrorCategory.aspx");
                    }
                    #endregion
                }
            }
        ...
        protected void UpdateRegionButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ClsSystem.UpdateErrorCategory(lblRegionCode.Text, txtRegionDesc.Text.Trim(), chkIsActive.Checked.ToString());
