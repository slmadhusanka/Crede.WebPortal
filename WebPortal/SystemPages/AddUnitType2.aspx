<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddUnitType2.aspx.cs" Inherits="WebPortal.SystemPages.AddUnitType2" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Add Unit Type 2 information</h3>
                </div>
                <div class="panel-body">
                    ...
                    <div class="form-horizontal col-xs-12 col-sm-12 col-lg-6">
                        <div class="form-group">
                            <asp:Label ID="lblUnitTyp2Desc" runat="server" AssociatedControlID="txtUnitTyp2Desc" CssClass="control-label col-xs-12 col-sm-4 col-lg-3">Unit type 2 <span class="red-star">*</span> :</asp:Label>
                            <div class="col-xs-12 col-sm-7 col-lg-8">
                                <asp:TextBox ID="txtUnitTyp2Desc" runat="server" CssClass="form-control" TextMode="MultiLine" Rows="3">
                                </asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtUnitTyp2Desc"
                                    CssClass="failureNotification" ErrorMessage="*Unit type 2 is required." Display="Dynamic"
                                    ToolTip="Unit type 2 is required." ValidationGroup="RegisterUserValidationGroup"></asp:RequiredFieldValidator>
                            </div>
                        </div>
                    </div>
                    <div class="form-horizontal col-xs-12 col-sm-12 col-lg-6">
                ...
                <div class="panel-footer">
                    <div class="pull-right">
                        <asp:LinkButton ID="btnRefresh" runat="server" CssClass="btn btn-warning" CausesValidation="false" PostBackUrl="~/SystemPages/ListOfUnitType2.aspx"><i class="fa fa-times" aria-hidden="true"></i> Cancel</asp:LinkButton>
