<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListOfPossibleConsequence.aspx.cs" Inherits="WebPortal.SystemPages.ListOfPossibleConsequence" %>
    ...
    <div class="pagetitle">
          ...
          <nav>
            <ol class="breadcrumb">
              ...
              <li class="breadcrumb-item active">Possible Consequence </li>
            </ol>
          </nav>
        </div><!-- End Page Title -->
        ...
        <div class="col-lg-12">
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <div class="pull-left">
                        <h5 class="card-title">Possible Consequence</h5>
                    </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvPossibleConsequence" runat="server" AutoGenerateColumns="False"
...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="PageScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function pageLoad() {
            $('#MainContent_gvPossibleConsequence> thead > tr:eq(0)').find('.no-sort').attr('data-orderable', 'false');

            var table = $("#MainContent_gvPossibleConsequence").DataTable({
                pageLength: 100,
                "order": [[1, "asc"]],
                dom: "lrt<'myinfo'i>p",
                ...
                buttons: {
                    ...
                    delete: {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "ListOfPossibleConsequence.aspx/DeleteERROR",
