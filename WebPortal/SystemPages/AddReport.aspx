<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddReport.aspx.cs" Inherits="WebPortal.SystemPages.AddReport" %>
        ...
        <ContentTemplate>
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <h3 class="panel-title">Add report information</h3>
                </div>
                    ...
                    <div class="form-horizontal col-xs-12 col-sm-12 col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-7 col-lg-8">
                                <asp:TextBox ID="txtReportCode" runat="server" CssClass="form-control">
                                </asp:TextBox>
                                <asp:RequiredFieldValidator ID="rfvReportCode" runat="server" ControlToValidate="txtReportCode" 
                                    CssClass="failureNotification" ErrorMessage="*Report code is required."  Display="Dynamic" ToolTip="Report code is required."
                                    ValidationGroup="ReportValidationGroup"></asp:RequiredFieldValidator>
                    ...
                    <div class="form-horizontal col-xs-12 col-sm-12 col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="col-xs-12 col-sm-offset-4 col-lg-offset-3 col-sm-7 col-lg-8">
                                <div class="checkbox">
                                    <asp:Label ID="Label6" runat="server" AssociatedControlID="chkIsSebdEnable">
                                        <asp:CheckBox ID="chkIsSebdEnable" runat="server" Checked="true" />Send enable
                                    </asp:Label>
                                </div>
                                <div class="checkbox">
