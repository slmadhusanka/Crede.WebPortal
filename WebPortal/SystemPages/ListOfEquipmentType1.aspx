<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListOfEquipmentType1.aspx.cs" Inherits="WebPortal.SystemPages.ListOfUnitType1" %>
    ...
    <div class="card hdl-card">
        <div class="card-header">
            ...
            <div class="pull-right">
                <asp:LinkButton ID="btnAddNew" runat="server" PostBackUrl="~/SystemPages/AddEquipmentType1.aspx" CssClass="btn btn-primary btn-sm">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="table-responsive">
                            <asp:GridView ID="gvUnitTyp1" runat="server" AutoGenerateColumns="False"
                                OnRowEditing="gvUnitTyp1_RowEditing" OnRowDataBound="gvUnitTyp1_RowDataBound"
                                ShowHeaderWhenEmpty="true" CssClass="table table-bordered table-striped table-hover">
                                <Columns>
                                    <asp:BoundField HeaderText="Unit type code" DataField="UnitType1Code" ItemStyle-CssClass="hide1" HeaderStyle-CssClass="hide1">
                                        ...
                                        <ItemTemplate>
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu">
                                                    <li>
                                                         <asp:LinkButton style="color: #212529;" ID="btnEdit" CssClass="dropdown-item" runat="server" CommandName="Edit" AlternateText="Edit" ToolTip="Click to Edit">
                                                             <i class="bi bi-pencil"></i> Edit
                                                         </asp:LinkButton>
                                                    </li>
                                                    <li>
                                                        <button style="color: #dc3545;" type="button" class="dropdown-item" onclick='customDeleteDialouge("<%# Eval("UnitType1Code") %>", "<%# HttpUtility.JavaScriptStringEncode(Convert.ToString(Eval("Description"))) %>")'>
...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="PageScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function pageLoad() {
            $('#MainContent_gvUnitTyp1 > thead > tr:eq(0)').find('.no-sort').attr('data-orderable', 'false');

            var table = $("#MainContent_gvUnitTyp1").DataTable({
                pageLength: 100,
                "order": [[0, "desc"]],
                dom: "lrt<'myinfo'i>p",
        ...
        function customDeleteDialouge(id, message) {
            var text = "Are you sure you want to delete '" + message + "' Equipment  type?";
            var title = "Delete '" + message + "' Equipment type";
            $('#dvAlert').html(text);
                ...
                buttons: {
                    ...
                    delete: {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "ListOfEquipmentType1.aspx/DeleteUnitType1",
