<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateRegion.aspx.cs" Inherits="WebPortal.SystemPages.UpdateRegion" %>
            ...
            <div class="pagetitle">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Edit Region Information</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <asp:HyperLink CssClass="btn-circle btn btn-back" ID="HyperLink1" runat="server" NavigateUrl="~/SystemPages/ListOfRegion.aspx"><i class="fa fa-arrow-left" aria-hidden="true"></i></asp:HyperLink>
                    <h5 class="card-title">Edit Region Information</h5>
                </div>
                <div class="card-body">
                    <!--Success alert-->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group hide hide1">
                            <asp:Label CssClass="form-label" ID="RegionCodeLabel" runat="server" AssociatedControlID="lblRegionCode" Visible="false">Region Code:</asp:Label>
                            
                                <asp:Label ID="lblRegionCode" runat="server" Visible="false"></asp:Label>
                            
                        </div>
                        <div class="col-md-12 form-group">
                            <asp:Label ID="lblregionDesc" runat="server" AssociatedControlID="txtRegionDesc" CssClass="form-label">Region <span class="red-star">*</span> :</asp:Label>
                        ...
                        <div class="col-md-12 form-group">
                            <asp:Label ID="lblDescriptionShort" runat="server" AssociatedControlID="txtDescriptionShort" CssClass="form-label">Short description :</asp:Label>
                               ...
                               <%-- <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtDescriptionShort"
                                    CssClass="failureNotification" ErrorMessage="*Short description is required." Display="Dynamic"
                                    ToolTip="Short description is required." ValidationGroup="RegisterUserValidationGroup"></asp:RequiredFieldValidator>--%>
