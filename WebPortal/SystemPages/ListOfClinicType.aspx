<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListOfClinicType.aspx.cs" Inherits="WebPortal.SystemPages.ListOfFacilityType" %>
                    ...
                    <div class="col-lg-12">
                        <div class="card hdl-card">
                            <div class="card-header">
                                <div class="pull-left">
                                    <h5 class="card-title">Clinic Type</h5>
                                </div>
                                <asp:LinkButton ID="btnAddNew" runat="server" PostBackUrl="~/SystemPages/AddClinicType.aspx" CssClass="btn btn-primary btn-sm">
                                    ...
                                    <ContentTemplate>
                                        ...
                                        <div class="table-responsive">
                                             <asp:GridView ID="gvFacility" runat="server" AutoGenerateColumns="False"
                                                OnRowEditing="gvFacility_RowEditing" OnRowDataBound="gvFacility_RowDataBound"
                                                ShowHeaderWhenEmpty="true" CssClass="table table-bordered table-striped table-hover">
                                                <Columns>
                                                    <asp:BoundField HeaderText="Clinic type code" DataField="FacilityTypeCode">
                                                        ...
                                                        <ItemTemplate>
                                                            <div class="btn-group">
                                                                ...
                                                                <ul class="dropdown-menu">
                                                                    ...
                                                                    <li>
                                                                        <button style="color: #dc3545;" type="button" class="dropdown-item" onclick='customDeleteDialouge("<%# Eval("FacilityTypeCode") %>", "<%# HttpUtility.JavaScriptStringEncode(Convert.ToString(Eval("Description"))) %>")'>
...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="PageScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function pageLoad() {
            $('#MainContent_gvFacility > thead > tr:eq(0)').find('.no-sort').attr('data-orderable', 'false');

            var table = $("#MainContent_gvFacility").DataTable({
                pageLength: 100,
                "order": [[1, "asc"]],
                dom: "lrt<'myinfo'i>p",
        ...
        function customDeleteDialouge(id, message) {
            var text = "Are you sure you want to delete '" + message + "' Clinic type?";
            var title = "Delete '" + message + "' Clinic type";
            $('#dvAlert').html(text);
                ...
                buttons: {
                    ...
                    delete: {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "ListOfClinicType.aspx/DeleteFacilityType",
