<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddRegion.aspx.cs" Inherits="WebPortal.SystemPages.AddRegion" %>
        ...
        <ContentTemplate>
            <div class="pagetitle">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Add Region Information</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <asp:HyperLink CssClass="btn-circle btn btn-back hide" ID="HyperLink1" runat="server" NavigateUrl="~/SystemPages/ListOfRegion.aspx"><i class="fa fa-arrow-left" aria-hidden="true"></i></asp:HyperLink>
                    <h5 class="card-title">Add Region Information</h5>
                </div>
                <div class="card-body">
                    <!--Success alert-->
