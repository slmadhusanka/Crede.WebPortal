<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListOfRegion.aspx.cs" Inherits="WebPortal.SystemPages.ListOfRegion" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <div class="pull-left">
                        <h5 class="card-title">Regions list</h5>
                    </div>
                ...
                <ContentTemplate>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvRegion" runat="server" AutoGenerateColumns="False"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="Region Code" DataField="RegionCode" ItemStyle-CssClass="hide1" HeaderStyle-CssClass="hide1">
                                    ...
                                    <ItemTemplate>
                                         <div class="btn-group">
                                              ...
                                              <ul class="dropdown-menu">
                                                ...
                                                <li>
                                                    <button style="color: #dc3545;" type="button" class="dropdown-item" onclick='customDeleteDialouge("<%# Eval("RegionCode") %>", "<%# HttpUtility.JavaScriptStringEncode(Convert.ToString(Eval("Description"))) %>")'>
...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="PageScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function pageLoad() {
            $('#MainContent_gvRegion > thead > tr:eq(0)').find('.no-sort').attr('data-orderable', 'false');

            var table = $("#MainContent_gvRegion").DataTable({
                pageLength: 100,
                "order": [[1, "asc"]],
                dom: "lrt<'myinfo'i>p",
                ...
                buttons: {
                    ...
                    delete: {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "ListOfRegion.aspx/DeleteZone",
