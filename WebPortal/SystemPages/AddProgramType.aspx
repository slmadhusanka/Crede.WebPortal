<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddProgramType.aspx.cs" Inherits="WebPortal.SystemPages.AddProgramType" %>
        ...
        <ContentTemplate>
            <div class="pagetitle">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Add Program Type information</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    ...
                    <h5 class="card-title">Add Program Type information</h5>
                </div>
                <div class="card-body">
                    <!--Success alert-->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="col-md-12 form-group">
                            <asp:Label ID="lblProgramTypeDesc" runat="server" CssClass="form-label" AssociatedControlID="txtProgramTypeDesc">Program type <span class="red-star">*</span> :</asp:Label>
                            
                                <asp:TextBox ID="txtProgramTypeDesc" runat="server" CssClass="form-control">
                                </asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtProgramTypeDesc"
                                    CssClass="failureNotification" ErrorMessage="*Program type is required." Display="Dynamic"
                                    ToolTip="Program type is required." ValidationGroup="RegisterUserValidationGroup"></asp:RequiredFieldValidator>
                ...
                <div class="card-footer">
                    <div class="pull-right">
                        <asp:LinkButton ID="btnRefresh" runat="server" CssClass="btn btn-secondary btn-sm" CausesValidation="false" PostBackUrl="~/SystemPages/ListOfProgramType.aspx">
