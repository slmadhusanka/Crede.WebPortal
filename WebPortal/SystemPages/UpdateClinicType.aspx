<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateClinicType.aspx.cs" Inherits="WebPortal.SystemPages.UpdateFacilityType" %>
            ...
            <div class="pagetitle">
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Edit Clinic Type Information</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
                ...
                <div class="col-lg-12">
                    <div class="card hdl-card">
                        <div class="card-header">
                            ...
                            <h5 class="card-title">Edit Clinic Type Information</h5>
                        </div>
                        <div class="card-body">
                            <!--Success alert-->
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group hide hide1">
                                    <asp:Label ID="FacilityCodeLabel" runat="server" AssociatedControlID="lblFacilityCode" Visible="false" CssClass="form-label">Clinic Type Code:</asp:Label>
                                    
                                        <asp:Label CssClass="form-control" ID="lblFacilityCode" runat="server" AssociatedControlID="txtFacilityDesc" Visible="false"></asp:Label>
                                ...
                                <div class="col-md-6 form-group">
                                    <asp:Label ID="lblFacilityDesc" runat="server" AssociatedControlID="txtFacilityDesc" CssClass="form-label">Clinic type <span class="red-star">*</span> :</asp:Label>
                                        ...
                                        <asp:TextBox ID="txtFacilityDesc" runat="server" CssClass="form-control">
                                        </asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtFacilityDesc" Display="Dynamic"
                                ...
                                <div class="col-md-12 form-group">
                                    <asp:Label ID="lblDescriptionLong" runat="server" AssociatedControlID="txtDescriptionLong" CssClass="form-label">Long description :</asp:Label>
                                        ...
                                        <asp:TextBox ID="txtDescriptionLong" runat="server" CssClass="form-control" TextMode = "MultiLine" Rows="2">
                                        </asp:TextBox>
