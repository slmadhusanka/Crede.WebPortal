...
{
    public partial class AddUnitType1 : System.Web.UI.Page
    {
        ...
        protected void UpdateUserButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ClsSystem.CreateUnitType1(txtUnitTyp1Desc.Text.Trim().Replace("'", "''"), chkIsActive.Checked.ToString(), txtDescriptionShort.Text.Trim().Replace("'", "''"));
