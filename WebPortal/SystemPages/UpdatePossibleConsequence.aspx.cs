...
{
    public partial class UpdatePossibleConsequence : System.Web.UI.Page
    {
            ...
            try
            {
                if (!IsPostBack)
                {
                    ...
                    if (Session["RegionData"] != null)
                    {
                        ...
                        PossibleConsequence objError = (PossibleConsequence)(Session["RegionData"]);
        ...
        protected void UpdateRegionButton_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    ClsSystem.UpdatePossibleConsequence(lblRegionCode.Text, txtRegionDesc.Text.Trim(), chkIsActive.Checked.ToString());
                    //ClsCommon.setRecordUpdateStatusInDb("Region", "RegionCode", "Edited", lblRegionCode.Text);
                    SuccessMessage.Text = "Possible Consequence Updated Successfully";
