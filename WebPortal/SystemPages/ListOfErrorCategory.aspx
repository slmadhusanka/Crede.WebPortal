<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListOfErrorCategory.aspx.cs" Inherits="WebPortal.SystemPages.ListOfErrorCategory" %>
        ...
        <div class="col-lg-12">
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <div class="pull-left">
                        <h5 class="card-title">Error Category</h5>
                    </div>
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <div class="table-responsive">
                        <asp:GridView ID="gvErrorCat" runat="server" AutoGenerateColumns="False"
...
<asp:Content ID="ScriptContent" ContentPlaceHolderID="PageScriptContent" runat="server">
    <script type="text/javascript">
        ...
        function pageLoad() {
            $('#MainContent_gvErrorCat > thead > tr:eq(0)').find('.no-sort').attr('data-orderable', 'false');

            var table = $("#MainContent_gvErrorCat").DataTable({
                pageLength: 100,
                "order": [[1, "asc"]],
                dom: "lrt<'myinfo'i>p",
                ...
                buttons: {
                    ...
                    delete: {
                        ...
                        action: function () {
                            $.ajax({
                                type: "POST",
                                url: "ListOfErrorCategory.aspx/DeleteERROR",
