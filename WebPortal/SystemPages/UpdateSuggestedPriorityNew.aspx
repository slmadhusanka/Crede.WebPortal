<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="UpdateSuggestedPriorityNew.aspx.cs" Inherits="WebPortal.SystemPages.UpdateSuggestedPriorityNew" %>
              ...
              <nav>
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item">Table Maintenance</li>
                    <li class="breadcrumb-item">Suggested Priority</li>
                  <li class="breadcrumb-item active">Edit Suggested Priority</li>
                </ol>
              </nav>
            </div><!-- End Page Title -->
          ...
          <div class="row">
            ...
            <div class="card hdl-card">
                <div class="card-header">
                    <asp:HyperLink CssClass="btn-circle btn btn-back" ID="HyperLink1" runat="server" NavigateUrl="~/SystemPages/ListOfSuggestedPriorityNew.aspx"><i class="fa fa-arrow-left" aria-hidden="true"></i></asp:HyperLink>
                    <h5 class="card-title">Edit Suggested Priority</h5>
                </div>
                <div class="card-body">
                    <!--Success alert-->
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group hide hide1">
                            <asp:Label CssClass="form-label" ID="RegionCodeLabel" runat="server" AssociatedControlID="lblRegionCode" Visible="false">Suggested Priority:</asp:Label>
                            
                                <asp:Label ID="lblRegionCode" runat="server" Visible="false"></asp:Label>
                            
                        </div>
                        <div class="col-md-12 form-group">
                            <asp:Label ID="lblregionDesc" runat="server" AssociatedControlID="txtRegionDesc" CssClass="form-label">Suggested Priority <span class="red-star">*</span> :</asp:Label>
                ...
                <div class="card-footer">
                    <div class="pull-right">
                        <asp:LinkButton ID="btnRefresh" runat="server" CssClass="btn btn-secondary btn-sm" CausesValidation="false" PostBackUrl="~/SystemPages/ListOfSuggestedPriorityNew.aspx">
